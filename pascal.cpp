...
void mas_copy(unsigned long long *mas, unsigned long long *new_mas, unsigned long long new_mas_len)		//Ôóíêöèÿ êîïèðîâàíèÿ ìàññèâîâ (ìàññèâû äîëæíû áûòü îäèíàêîâîé äëèíû)
{
...
int main()
{
	...
	cout << "Ââåäèòå êîëè÷åñòâî ñòðîê òðåóãîëüíèêà ïàñêàëÿ: ";
	cin >> lines;
